...
if(isset($_POST['update_profile'])){
    ...
    mysqli_query($conn, "UPDATE `user_form` SET name = '$update_name', contact = '$update_contact', address = '$update_address', email = '$update_email' 
    ...
    if(!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass)){
        if($update_pass != $old_pass){
            ...
            mysqli_query($conn, "UPDATE `user_form` SET password = '$confirm_pass' 
            WHERE id = '$user_id'") or die('query failed');
    ...
    if(!empty($update_image)){
        if($update_image_size > 2000000){
            ...
            $image_update_query = mysqli_query($conn, "UPDATE `user_form` SET image = '$update_image' 
            WHERE id = '$user_id'") or die('query failed');
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="flex">
                <div class="inputBox">
                    ...
                    <span>Address: </span>
                    <input type="textarea" name="update_address" value="<?php echo $fetch['address'] ?>" class="box">
            ...
            <input type="submit" value="Update User Profile" name="update_profile" class="btn">
