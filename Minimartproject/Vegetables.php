...
<head>
    ...
    <title>MiniMart|Vegetables</title>
...
<div class="box-container">
   ...
   <?php
        ...
        $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'Grocery'&& SubCategory ='Vegetables'") or die('query failed');
