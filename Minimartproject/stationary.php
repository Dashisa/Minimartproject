...
<head>
    ...
    <title>MiniMart|Stationary</title>
...
<section class="category" id="category">
    ...
    <h1 class="heading">Stationary </h1>
...
<div class="box-container">
   ...
   <?php
        ...
        $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'Stationary'&& SubCategory ='Stationary'") or die('query failed');
