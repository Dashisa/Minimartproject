...
if(!isset($admin_id)){
 ...
 if(isset($_GET['delete'])){
    ...
    mysqli_query($conn, "DELETE FROM `users` WHERE email = '$email'") or die('query failed');
...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Contact : <span><?php echo $fetch_users['number']; ?></span></p>
      ...
      <?php
         ...
         echo '<p class="empty">no customers yet!</p>';
      }
      ?>
   </div>
