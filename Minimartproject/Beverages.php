...
<header>
    ...
    <a href="index.html" class="logo">MiniMart<span>.</span></a>

    <nav class="navbar">
    <a href="category.php" class="fa fa-chevron-left"></a>
...
<div class="box-container">
   ...
   <?php
        ...
        $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'Grocery'&& SubCategory ='Beverages'") or die('query failed');
